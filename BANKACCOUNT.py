...
while True:
    ...
    if create_account == 0:
        ...
        while True:
                access_account = int(input('Do you want to access your account "0" for NO and "1" for YES :'))
                ...
                if access_account == 1:
                    ...
                    if enter_acn in BankAccount.accounts :
                        ...
                        if enter_pin == account.pin :
                            ...
                            while True:
                                options = int(input('1.Check Balance\n2.Deposit Amount\n3.Withdraw Amount\n0.EXIT '))
                                #Checking balance
                                if options == 1:
                                ...
                                #Depositing amount
                                    ...
                                    print(f'Amount deposited, total balance is : {account.balance}')
                                    continue
                                #Withdrawing amount
                                elif options == 3:
                                    amount_to_withdraw = int(input('Enter amount to withdraw :'))
                                    account.withdraw(amount_to_withdraw)
                                    print(f'Amount withdrawn, total balance is : {account.balance}')
                                    continue
                                elif options == 0:
                                    break
                                else:
        ...
        recreate_account = int(input('Enter "0" to exit or "1" to access existing accounts or "2" to create a new account : '))
